...
wget -O tika-app.jar https://downloads.apache.org/tika/tika-app-1.24.jar
...
java -jar tika-app.jar -T -i AS-2017-02-21 -o tmp
rm -Rf AS-2017-02-21
mv tmp AS-1948-1998
...
java -jar tika-app.jar -T -i RO-1948-1998 -o tmp
rm -Rf RO-1948-1998
mv tmp RO-1948-1998
...
java -jar tika-app.jar -T -i RU-1948-1998 -o tmp
rm -Rf RU-1948-1998
mv tmp RU-1948-1998

# Remove Apache Tika and datasets
rm AS-1948-1998.zip RO-1948-1998.zip RU-1948-1998.zip tika-app.jar
